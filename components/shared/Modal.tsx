...
const Modal = ({ children, isOpen, onClose }: ModalProps) => {
  ...
  return createPortal(
    <>
      ...
      >
        <div className="relative bg-white dark:bg-dark-400 w-10/12 max-w-[768px] h-fit max-h-[calc(100%-80px)] overflow-y-auto overflow-x-hidden">
          <div
            className="absolute flex items-center justify-center w-4 h-4 cursor-pointer right-2 top-2"
