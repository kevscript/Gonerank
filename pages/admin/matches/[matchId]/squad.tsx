      ...
      <div className="mt-16">
        <div>
          <label>
            <select
              ...
              className="w-full h-10 px-2 dark:bg-dark-400"
            >
        ...
        <ul className="flex flex-col mt-8 flex-nowrap gap-y-1 lg:flex-row lg:flex-wrap lg:gap-2">
          {squad &&
            squad.map((p) => (
              <li
                key={p.id}
                className="relative flex items-center justify-between w-full p-2 bg-white border border-gray-100 dark:bg-dark-400 flex-nowrap lg:max-w-xs"
              >
        ...
        <Modal isOpen={modalIsOpen} onClose={() => setModalIsOpen(false)}>
          <>
                  ...
                  squad.map((p) => {
                    ...
                    if (alreadyExisted) {
                      return (
                        <li
                          key={p.id}
                          className="flex w-48 p-1 border border-gray-200 dark:bg-dark-500 dark:border-dark-300 bg-gray-50 flex-nowrap"
                        >
            ...
            <div className="flex justify-end w-full mt-8 flex-nowrap gap-x-2">
