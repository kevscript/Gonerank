...
const ChartPlayersList = ({
  ...
  return (
    <div className="relative flex p-[1px] overflow-hidden bg-gray-200 rounded-sm w-72 dark:bg-dark-300">
      <ul className="flex flex-col w-full overflow-x-hidden overflow-y-auto rounded-sm">
        {players
          ...
          .map((player, i) => (
            <li
              key={player.id}
              className={`h-10 flex shrink-0 items-center cursor-pointer group border-b-2 border-gray-100 dark:border-dark-300 ${
            ...
            >
              ...
              />
              <div
                className={`w-2 h-2 rounded-full mx-2 md:mx-4 shrink-0`}
                style={{
