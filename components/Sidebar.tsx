...
const Sidebar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 bottom-0 w-16 bg-white border-r-[2px] border-gray-100 pt-8 pb-8 xl:pb-0 flex flex-col items-center xl:w-64 z-10 dark:bg-slate-900 dark:border-slate-600">
      {/* Sidebar Header */}
